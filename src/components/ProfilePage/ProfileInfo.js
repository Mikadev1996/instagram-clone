...
const ProfileInfo = ({username, userProfilePic, userPosts, handleEditProfile, userBio, isCurrentUser}) => {
    return (
        <div className="profile-info">
            ...
            <div className="profile-info-details">
                <div className="profile-info-detail">
                    ...
                    {isCurrentUser && <button onClick={() => handleEditProfile()}>Edit Profile</button>}
                </div>
