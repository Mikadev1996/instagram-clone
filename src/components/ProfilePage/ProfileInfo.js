...
const ProfileInfo = ({username, userProfilePic, userPosts, handleEditProfile, userBio, editProfile}) => {
    return (
        <div className="profile-info">
            ...
            <div className="profile-info-details">
                <div className="profile-info-detail">
                    ...
                    {editProfile && <button onClick={() => handleEditProfile()}>Edit Profile</button>}
                </div>
